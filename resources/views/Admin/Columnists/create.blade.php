        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Add Columnist</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="card-body">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Add Columnist</h3>
            </div>
            <!-- /.card-header -->
            @if (count($errors) > 0)
            ...
            @endif
            <!-- form start -->
            <form method="post" action="{{ route('Columnists.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-success">Add Columnist</button>
                </div>
            </form>
        </div>
    </div>
