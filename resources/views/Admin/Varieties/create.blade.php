    ...
    <div class="card-body">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Add Variety</h3>
            </div>
            <!-- /.card-header -->
            @if (count($errors) > 0)
            ...
            @endif
            <!-- form start -->
            <form method="post" action="{{ route('Varieties.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="input-group mb-3">
                        ...
                        <select class="custom-select" id="inputGroupSelect01" name="types">
                            ...
                            <option value="1">Sports World</option>
                            <option value="2">Trendy News</option>
                        </select>
                    </div>
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-success">Add Variety</button>
                </div>
            </form>
        </div>
    </div>
